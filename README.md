...
## Author
Ahmed Ajlal - COSC 2436, Spring 2026

## Description
This portfolio demonstrates my work throughout the semester in COSC 2436. The labs cover searching, sorting, recursion, hash tables, graphs, trees, shortest path algorithms, greedy methods, dynamic programming, and regression. My goal with this repository is to organize my chapter labs clearly and show my understanding of algorithms from each chapter.
...
Sprin 2026, based on *Grokking Algorithms* by Aditya Bhargava.
